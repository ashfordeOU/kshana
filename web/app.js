...
const SCENARIOS = [
  ...
  ["ins-trn-coast.toml", "INS/TRN coast — outage cost by IMU grade (modelled)",
    "INS/TRN coast", "How far does position drift during a navigation outage, and when does it cross 10 m and 50 m? (modelled)"],
  ...
  ["araim-reference-check.toml", "ARAIM reference check — against published WG-C vectors",
    "ARAIM reference check", "Do the engine's protection levels land on the published Working Group C worked examples?"],
  ...
  ["tracking-loop.toml", "Tracking loop — loss of lock, relock and spoof pull-in (modelled)",
    "Tracking loop", "At what C/N0 does a receiver actually lose lock, and can a spoofer pull the loops over? (modelled)"],
  ...
  ["lunar-jamming.toml", "Lunar jamming — per-satellite J/S and the denial contour (modelled)",
    "Lunar jamming", "How far off can a jammer sit and still deny a lunar surface receiver? (modelled)"],
  ["lunar-vlbi-fim.toml", "Lunar VLBI information — delay schedule to station covariance (modelled)",
    "Lunar VLBI information", "What station-coordinate accuracy does a given VLBI tracking schedule actually buy? (modelled)"],
  ["lunar-frame-campaign.toml", "Lunar frame campaign — datum from a simulated observing campaign (modelled)",
    "Lunar frame campaign", "What datum accuracy comes out of an observing campaign rather than an injected transform? (modelled)"],
  ["lunar-llr-datum.toml", "Lunar LLR datum — datum from real archived laser ranging (modelled)",
    "Lunar LLR datum", "What does the lunar datum look like when the campaign is real archived laser ranging? (modelled)"],
  ["aperture-duty-cycle.toml", "Aperture duty cycle — navigation versus communications sharing (modelled)",
    "Aperture duty cycle", "When one aperture serves both navigation and communications, what outage does that cost? (modelled)"],
