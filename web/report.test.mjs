...
import { buildReportHtml, escapeHtml, reportFilename } from "./report.mjs";
...
// each SVG present; a malicious scenario TOML is escaped (XSS oracle).
{
  const payload = {
    ...
    fomRows: [
      { clockLabel: "optical", label: "Holdover", unit: "s", value: 120 },
      { clockLabel: "csac", label: "Holdover", unit: "s", value: 12 },
    ],
    svgs: [
