...
| **Reference frames & time systems** | none | Output is in **TEME** only | No TEME→ECEF/ITRF/J2000 rotations; no UTC/UT1/TAI/TT, no leap seconds, no DUT1 | **P1** (next): `src/time.rs` + frame reduction |
