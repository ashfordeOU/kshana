...
| Interoperability & standards (RINEX/SP3/SPICE/CCSDS) | partial | RINEX 3 **GPS + Galileo** NAV ingested + propagated + runnable as a constellation; SP3-c/d precise-ephemeris **read ↔ write round trip** (parse, plus export of propagated orbits for Ginan/RTKLIB/gLAB). No BeiDou/GLONASS, no SP3 interpolation/propagator, no SPICE/CCSDS yet — **P2** "annex adjacent domains via standard formats" |
