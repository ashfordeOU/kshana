...
| LRO lunar | `pending` | The third, heterogeneous dataset (lunar central body via GRGM + NAIF SPK truth) — its own engine-extension wave; honest RMS reported even if above 5 m. **Datasets validated: 2 of 3.** |
