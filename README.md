...
```mermaid
flowchart TD
    cli["CLI · Python · WebAssembly · MCP server · JetBrains plugin"] --> api["api — run_toml: typed dispatch over 37 kinds"]
...
│   ├── api.rs · main.rs · lib.rs              # typed dispatch (37 kinds) + CLI + crate root
