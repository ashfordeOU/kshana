...
<p align="center">
  <img src="docs/assets/figures/validation-breakdown.png" alt="Verification status across all 93 capabilities: 42 Validated (checked vs external oracle), 47 Modelled, 4 Partner-owned" width="780">
  <br><sub>42 Validated · 47 Modelled · 4 Partner — <a href="docs/assets/figures/validation-breakdown.svg">SVG</a></sub>
</p>
...
<p align="center">
  <img src="docs/assets/diagrams/validation-provenance.png" alt="How a capability earns its label: Requirement maps to a module in src, to a test in tests, to an external oracle (real dataset, independent reference implementation, or published vectors), to a status — with a CI-enforced guard that no capability can be Validated without an external oracle. Live counts: 42 Validated, 47 Modelled, 4 Partner, 93 total" width="900">
...
the full machine-checked matrix is **93 rows — 42 VALIDATED, 47 MODELLED, 4 PARTNER**
