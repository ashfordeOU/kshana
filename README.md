...
```mermaid
flowchart TD
    cli["CLI · Python · WebAssembly · MCP server · JetBrains plugin"] --> api["api — run_toml: typed dispatch over 41 kinds"]
...
│   ├── api.rs · main.rs · lib.rs              # typed dispatch (41 kinds) + CLI + crate root
