...
<p align="center">
  ...
  <a href="#validation-at-a-glance"><img src="https://img.shields.io/badge/validated-60%20external%20oracles-3fb950" alt="60 capabilities validated against independent external oracles (real data, independent libraries, or published reference vectors); 86 more are honestly labelled MODELLED and 4 are PARTNER-owned — see Validation at a glance"></a>
...
<p align="center"><em><strong>Validated, not asserted.</strong> &nbsp;666/666 AIAA SGP4 vectors to <strong>4.12&nbsp;mm</strong> · Cowell force model <strong>0.08&nbsp;m</strong> vs Orekit&nbsp;12.2 · Galileo <strong>0.61&nbsp;m</strong> / Swarm-A <strong>0.10&nbsp;m</strong> vs real ESA precise ephemerides · GCRS→ITRS bit-for-bit vs SOFA/ERFA · ML metrics exact vs scikit-learn · <strong>60 of 150</strong> capabilities validated against independent external oracles; 86 honestly labelled Modelled.</em></p>
...
Each row is checked against an **independent external oracle** (real dataset, independent reference implementation, or published reference vectors) and re-checked in CI. [Full 150-row matrix →](#validation-at-a-glance)
...
<p align="center">
  <img src="docs/assets/figures/validation-breakdown.png" alt="Verification status across all 150 capabilities: 60 Validated (checked vs external oracle), 86 Modelled, 4 Partner-owned" width="780">
  <br><sub>60 Validated · 86 Modelled · 4 Partner — <a href="docs/assets/figures/validation-breakdown.svg">SVG</a></sub>
</p>
...
<p align="center">
  <img src="docs/assets/diagrams/validation-provenance.png" alt="How a capability earns its label: Requirement maps to a module in src, to a test in tests, to an external oracle (real dataset, independent reference implementation, or published vectors), to a status — with a CI-enforced guard that no capability can be Validated without an external oracle. Live counts: 60 Validated, 86 Modelled, 4 Partner, 150 total" width="900">
...
the full machine-checked matrix is **150 rows — 60 VALIDATED, 86 MODELLED, 4 PARTNER**
