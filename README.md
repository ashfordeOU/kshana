...
<p align="center">
  ...
  <a href="#validation-at-a-glance"><img src="https://img.shields.io/badge/validated-59%20external%20oracles-3fb950" alt="59 capabilities validated against independent external oracles (real data, independent libraries, or published reference vectors); 72 more are honestly labelled MODELLED and 4 are PARTNER-owned — see Validation at a glance"></a>
...
<p align="center"><em><strong>Validated, not asserted.</strong> &nbsp;666/666 AIAA SGP4 vectors to <strong>4.12&nbsp;mm</strong> · Cowell force model <strong>0.08&nbsp;m</strong> vs Orekit&nbsp;12.2 · Galileo <strong>0.61&nbsp;m</strong> / Swarm-A <strong>0.10&nbsp;m</strong> vs real ESA precise ephemerides · GCRS→ITRS bit-for-bit vs SOFA/ERFA · ML metrics exact vs scikit-learn · <strong>59 of 135</strong> capabilities validated against independent external oracles; 72 honestly labelled Modelled.</em></p>
...
Each row is checked against an **independent external oracle** (real dataset, independent reference implementation, or published reference vectors) and re-checked in CI. [Full 135-row matrix →](#validation-at-a-glance)
...
<p align="center">
  <img src="docs/assets/figures/validation-breakdown.png" alt="Verification status across all 135 capabilities: 59 Validated (checked vs external oracle), 72 Modelled, 4 Partner-owned" width="780">
  <br><sub>59 Validated · 72 Modelled · 4 Partner — <a href="docs/assets/figures/validation-breakdown.svg">SVG</a></sub>
</p>
...
```mermaid
flowchart TD
    cli["CLI · Python · WebAssembly<br/>MCP server · JetBrains plugin"] --> api["api — run_toml<br/>typed dispatch over 59 kinds"]
...
│   ├── api.rs · main.rs · lib.rs              # typed dispatch (59 kinds) + CLI + crate root
...
the full machine-checked matrix is **135 rows — 59 VALIDATED, 72 MODELLED, 4 PARTNER**
