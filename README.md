...
<p align="center">
  ...
  <a href="#validation-at-a-glance"><img src="https://img.shields.io/badge/validated-52%20external%20oracles-3fb950" alt="52 capabilities validated against independent external oracles (real data, independent libraries, or published reference vectors); 54 more are honestly labelled MODELLED and 4 are PARTNER-owned — see Validation at a glance"></a>
...
<p align="center"><em><strong>Validated, not asserted.</strong> &nbsp;666/666 AIAA SGP4 vectors to <strong>4.12&nbsp;mm</strong> · Cowell force model <strong>0.08&nbsp;m</strong> vs Orekit&nbsp;12.2 · Galileo <strong>0.61&nbsp;m</strong> / Swarm-A <strong>0.10&nbsp;m</strong> vs real ESA precise ephemerides · GCRS→ITRS bit-for-bit vs SOFA/ERFA · ML metrics exact vs scikit-learn · <strong>52 of 110</strong> capabilities validated against independent external oracles; 54 honestly labelled Modelled.</em></p>
...
<p align="center">
  <img src="docs/assets/figures/validation-breakdown.png" alt="Verification status across all 110 capabilities: 52 Validated (checked vs external oracle), 54 Modelled, 4 Partner-owned" width="780">
  <br><sub>52 Validated · 54 Modelled · 4 Partner — <a href="docs/assets/figures/validation-breakdown.svg">SVG</a></sub>
</p>
...
> **Status: v0.23.0 · a validated, reproducible simulation substrate for PNT resilience.**
...
<p align="center">
  <img src="docs/assets/diagrams/validation-provenance.png" alt="How a capability earns its label: Requirement maps to a module in src, to a test in tests, to an external oracle (real dataset, independent reference implementation, or published vectors), to a status — with a CI-enforced guard that no capability can be Validated without an external oracle. Live counts: 52 Validated, 54 Modelled, 4 Partner, 110 total" width="900">
...
<p align="center">
  <img src="docs/assets/figures/oracle-kind-stacked.png" alt="How each claim is backed: the Validated column is 51 of 51 ExternalDataset by construction (CI-enforced); Modelled rows are honestly tagged InternalConsistency, ReferenceImpl, or ExternalDataset; Partner rows have no Kshana oracle" width="62%">
  <br>
...
the full machine-checked matrix is **110 rows — 52 VALIDATED, 54 MODELLED, 4 PARTNER**
...
button from it); cite the version you used (e.g. `v0.23.0`) together with the
