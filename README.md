...
```mermaid
flowchart TD
    cli["CLI · Python · WebAssembly<br/>MCP server · JetBrains plugin"] --> api["api — run_toml<br/>typed dispatch over 48 kinds"]
...
│   ├── api.rs · main.rs · lib.rs              # typed dispatch (48 kinds) + CLI + crate root
