...
quiescent platform) to roughly $3~\mathrm{mg}/\sqrt{\mathrm{Hz}}$ (a noisy host). The figure of merit is the
...
\SI{2.5}{\milli\metre} versus navigation-grade \SI{0.75}{\metre} at the 95th
