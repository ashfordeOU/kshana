...
Position, navigation, and timing (PNT) underpin power-grid synchronisation,
...
area~\citep{misra2010,kaplan2017}. The operational consequence is not loss of a
gadget but loss of a \emph{reference}---the question that matters during an
...
That concession is a gift, because it names the gap precisely---the resilience
debate is starved not of physics but of \emph{reproducible, falsifiable,
like-for-like comparison}.

The gap is real, and it is worth stating by evidence rather than by assertion.
A number of capable open tools exist, but each answers a different question and
...
stack---inertial dead-reckoning, clock holdover, and time transfer---with a
...
agency precise orbits---but that battery is \emph{evidence}, not the
contribution. The contribution is the reproducible crossover study built on top
of it (Section~\ref{sec:crossover}): rather than reporting a single hero number,
...
\begin{enumerate}
  ...
  analytic stack reproduces a DE440/ANISE realization for the LRO reduced-dynamic
