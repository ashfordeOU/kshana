...
drift on a navigation-grade unit over the same 350 s outage, and optical two-way time
transfer of ~0.3 mm equivalent ranging versus ~150 mm for an RF (TWSTFT) link
[@giorgetta2013; @deschenes2016]. Quantum clock and inertial coefficients trace to the
strontium optical-lattice and cold-atom-interferometer literature [@origlia2015; @templier2022].
