...
fn units_json() -> serde_json::Value {
    let mut a = serde_json::json!({
        ...
        "arc_hours": {"unit": "h", "provenance": "input"},
        "epochs": {"unit": "count", "provenance": "input"},
        ...
        "sigma_measurement_nd": {"unit": "nondimensional (length or velocity, per observable)", "provenance": "computed"},
        "error_bound_km": {"unit": "km", "provenance": "input"},
        "max_iterations": {"unit": "count", "provenance": "input"},
        ...
        "link.reference_state[]": {"unit": "nondimensional rotating-frame state units", "provenance": "computed"},
    });
    let rest = serde_json::json!({
        "recovery_vs_arc[].epoch_index": {"unit": "count (index)", "provenance": "computed"},
        "recovery_vs_arc[].arc_time_tu": {"unit": "rotating-frame time units", "provenance": "computed"},
        "recovery_vs_arc[].arc_hours": {"unit": "h", "provenance": "computed"},
        "recovery_vs_arc[].n_measurements": {"unit": "count", "provenance": "computed"},
        ...
        "recovery_vs_arc[].mc_rms_velocity_mm_s": {"unit": "mm/s", "provenance": "computed"},
        "recovery_vs_arc[].mc_worst_position_km": {"unit": "km", "provenance": "computed"},
        "recovery_vs_arc[].trials_solved": {"unit": "count", "provenance": "computed"},
        "recovery_threshold.epoch_grid_hours": {"unit": "h", "provenance": "computed"},
        "recovery_threshold.noise_free_criterion.epoch_index": {"unit": "count (index)", "provenance": "computed"},
        "recovery_threshold.noise_free_criterion.n_measurements": {"unit": "count", "provenance": "computed"},
        "recovery_threshold.noise_free_criterion.arc_hours": {"unit": "h", "provenance": "computed"},
        "recovery_threshold.noise_free_criterion.arc_time_tu": {"unit": "rotating-frame time units", "provenance": "computed"},
        ...
        "recovery_threshold.noise_free_criterion.bracket_high_hours": {"unit": "h", "provenance": "computed"},
        "recovery_threshold.estimability_criterion.epoch_index": {"unit": "count (index)", "provenance": "computed"},
        "recovery_threshold.estimability_criterion.n_measurements": {"unit": "count", "provenance": "computed"},
        "recovery_threshold.estimability_criterion.arc_hours": {"unit": "h", "provenance": "computed"},
        "recovery_threshold.estimability_criterion.arc_time_tu": {"unit": "rotating-frame time units", "provenance": "computed"},
        "recovery_threshold.estimability_criterion.bracket_low_hours": {"unit": "h", "provenance": "computed"},
        "recovery_threshold.estimability_criterion.bracket_high_hours": {"unit": "h", "provenance": "computed"},
        "recovery_threshold.recovery_factor_sweep[].recovery_factor": {"unit": "fraction (dimensionless)", "provenance": "input"},
        "recovery_threshold.recovery_factor_sweep[].epoch_index": {"unit": "count (index)", "provenance": "computed"},
        "recovery_threshold.recovery_factor_sweep[].arc_hours": {"unit": "h", "provenance": "computed"},
        "recovery_threshold.error_bound_sweep[].error_bound_km": {"unit": "km", "provenance": "input"},
        "recovery_threshold.error_bound_sweep[].epoch_index": {"unit": "count (index)", "provenance": "computed"},
        "recovery_threshold.error_bound_sweep[].arc_hours": {"unit": "h", "provenance": "computed"},
        ...
        "claim_under_test.gramian_rank_threshold_hours": {"unit": "h", "provenance": "reference", "note": "quoted from cislunar-observability on the identical grid"},
        "claim_under_test.gramian_estimability_threshold_hours": {"unit": "h", "provenance": "reference"},
        "claim_under_test.estimator_noise_free_boundary_hours": {"unit": "h", "provenance": "computed"},
        "claim_under_test.estimator_estimability_boundary_hours": {"unit": "h", "provenance": "computed"},
        "claim_under_test.rank_ratio_estimator_over_gramian": {"unit": "ratio (dimensionless)", "provenance": "computed"},
        "claim_under_test.estimability_ratio_estimator_over_gramian": {"unit": "ratio (dimensionless)", "provenance": "computed"},
    });
    {
