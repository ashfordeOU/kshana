...
//! IAU 2006 CIO-locator (s) series — AUTO-GENERATED from the IAU SOFA / ERFA
//! `s06.c` reference by `tools/gen_s06.py`; do not edit by hand. The values are
//! IAU reference data. Coefficients are in arc-seconds (the `e-6` = micro-arcsec).

/// One term of the s+XY/2 series: eight fundamental-argument multipliers
/// `(l, l', F, D, Ω, L_Ve, L_E, pA)` and the sine/cosine coefficients (arcsec).
pub type S06Term = ([i8; 8], f64, f64);

/// Polynomial coefficients of s+XY/2 (arcsec), ascending powers of t.
pub const SP06: [f64; 6] = [
    94.00e-6,
    3808.65e-6,
    -122.68e-6,
    -72574.11e-6,
...
/// s+XY/2 terms of order t^0 (33 terms).
#[rustfmt::skip]
pub static S06_0: [S06Term; 33] = [
...
/// s+XY/2 terms of order t^1 (3 terms).
#[rustfmt::skip]
pub static S06_1: [S06Term; 3] = [
    ([0, 0, 0, 0, 2, 0, 0, 0], -0.07e-6, 3.57e-6),
    ([0, 0, 0, 0, 1, 0, 0, 0], 1.73e-6, -0.03e-6),
    ([0, 0, 2, -2, 3, 0, 0, 0], 0.00e-6, 0.48e-6),
];

/// s+XY/2 terms of order t^2 (25 terms).
#[rustfmt::skip]
pub static S06_2: [S06Term; 25] = [
...
/// s+XY/2 terms of order t^3 (4 terms).
#[rustfmt::skip]
pub static S06_3: [S06Term; 4] = [
...
/// s+XY/2 terms of order t^4 (1 terms).
#[rustfmt::skip]
pub static S06_4: [S06Term; 1] = [
