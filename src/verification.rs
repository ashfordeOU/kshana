...
pub fn verification_matrix() -> Vec<VerificationItem> {
    ...
    vec![
        ...
        VerificationItem {
            ...
            module: "src/integrity/hetero_budget.rs",
            tests: "integrity::hetero_budget::tests (correlated_fused_bias_dominates_independent_when_correlated) + tests/hetero_budget_reference.rs",
        ...
        VerificationItem {
            ...
            module: "src/integrity/gls_commonmode.rs",
            tests: "integrity::gls_commonmode::tests (common_mode_shift_inflates_statistic_but_not_contrasts) + tests/gls_reference.rs",
            oracle: "Independent numpy reproduction of the statistic + property test that a common-mode injection inflates it (InternalConsistency). Modelled scenario.",
            oracle_kind: InternalConsistency,
            status: Modelled,
        },
        VerificationItem {
            requirement: "Residual-outside-Omega undetectable common-mode bound",
            capability: "Irreducible undetectable common-mode error: min(alpha_ss, alpha_cm) fault magnitude escaping BOTH separation (whitened contrast norm) and the common-mode statistic (1^T Omega^-1 d); INFINITY when the fault direction lies outside the modelled Omega common axis (published honest blind spot)",
            module: "src/integrity/gls_commonmode.rs",
            tests: "integrity::gls_commonmode::tests (separation_alone_is_blind_to_common_mode, total_blind_spot_is_infinite)",
            oracle: "Property tests over the finite/infinite detectability boundary (InternalConsistency). PROVEN blind-spot bound; no accuracy claim. Modelled.",
            oracle_kind: InternalConsistency,
            status: Modelled,
        },
    ]
